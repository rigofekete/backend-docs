...
`HTTP` (`Hypertext Transfer Protocol`) is the web communication protocol commonly used in the application layer, and it is used to send and receive messages between clients and servers. 
